...
const Card = ({ data,reference }) => {
  return (
    <motion.div drag dragConstraints={} className="w-[16vw] h-[45vh] rounded-[2rem] text-white px-5 py-10 bg-black relative overflow-hidden">
      ...
      <div className="footer  absolute bottom-0 left-0 w-full h-15  ">
        ...
        {data.tag.isOpen ? (
          <div
            className={`w-full h-10 ${data.tag.tagColor ==='blue'? "bg-blue-500":'bg-green-500'

import { IoDocumentOutline, IoScale } from "react-icons/io5";
...
const Card = ({ data, reference }) => {
  return (
    <motion.div
      drag
      dragConstraints={reference} whileDrag={scale:1.2}
      className="w-[16vw] h-[45vh] rounded-[2rem] text-white px-5 py-10 bg-black relative overflow-hidden"
    >
